// $$FORK: We've commented out huge chunks of this file,
// so we don't need some of the imports
...
import {isEquivalentPosition, isOnEdge, selectionCollapsed} from "./dom"
...
// $$FORK: For now, this is implemented in our sync selection hook
