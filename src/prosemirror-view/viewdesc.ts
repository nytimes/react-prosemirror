...
import {domIndex, isEquivalentPosition, nodeSize, DOMNode} from "./dom.js"
...
export class MarkViewDesc extends ViewDesc {
  constructor(parent: ViewDesc | undefined, children: ViewDesc[], readonly mark: Mark, dom: DOMNode, contentDOM: HTMLElement) {
...
export class TextViewDesc extends NodeViewDesc {
  constructor(parent: ViewDesc | undefined, children: ViewDesc[], node: Node, outerDeco: readonly Decoration[],
