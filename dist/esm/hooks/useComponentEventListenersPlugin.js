...
import { createComponentEventListenersPlugin } from "../plugins/componentEventListenersPlugin.js";
/**
 ...
 */ export function useComponentEventListenersPlugin() {
    ...
    const componentEventListenersPlugin = useMemo(()=>createComponentEventListenersPlugin(registry), [
        registry
    ]);
    return {
