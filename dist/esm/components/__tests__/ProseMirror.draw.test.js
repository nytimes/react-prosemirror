/* eslint-disable @typescript-eslint/no-non-null-assertion */ import { act } from "@testing-library/react";
...
describe("EditorView draw", ()=>{
    ...
    it("redraws changed node views", ()=>{
        ...
        rerender({
            nodeViews: {
                horizontal_rule: /*#__PURE__*/ forwardRef(function Var(props, ref) {
