...
Object.defineProperty(exports, "useBeforeInput", {
    enumerable: true,
    get: ()=>useBeforeInput
});
...
function insertText(view, eventData) {
    ...
    if (options.bust) {
        ...
        const parentKey = _reactKeysJs.reactKeysPluginKey.getState(view.state)?.posToKey.get(parentPos);
        tr.setMeta(_reactKeysJs.reactKeysPluginKey, {
            type: "bustKey",
            payload: {
                key: parentKey
            }
...
function useBeforeInput(view) {
    const compositionTextRef = (0, _react.useRef)(null);
    const compositionMarks = (0, _react.useRef)(null);
    (0, _react.useEffect)(()=>{
        if (!view) return;
