/* eslint-disable jest/no-disabled-tests */ /* eslint-disable @typescript-eslint/no-explicit-any */ /* eslint-disable @typescript-eslint/no-non-null-assertion */ "use strict";
...
function setSel(view, sel) {
    const selection = typeof sel == "number" ? _prosemirrorState.Selection.near(view.state.doc.resolve(sel)) : sel;
    (0, _react.act)(()=>{
...
describe("EditorView", ()=>{
    ...
    it("can read the DOM selection", async ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one"), (0, _prosemirrorTestBuilder.hr)(), (0, _prosemirrorTestBuilder.blockquote)((0, _prosemirrorTestBuilder.p)("two")))
        });
        ...
        const one = await (0, _editorViewTestHelpersJs.findTextNode)(view.dom, "one");
        const two = await (0, _editorViewTestHelpersJs.findTextNode)(view.dom, "two");
        test(one, 0, 1);
        test(one, 1, 2);
        test(one, 3, 4);
    ...
    it.skip("returns sensible screen coordinates", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one"), (0, _prosemirrorTestBuilder.p)("two"))
        });
    ...
    it.skip("returns proper coordinates in code blocks", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.code_block)("a\nb\n"))
        }), p = [];
    ...
    it.skip("produces sensible screen coordinates in corner cases", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one", (0, _prosemirrorTestBuilder.em)("two", (0, _prosemirrorTestBuilder.strong)("three"), img), (0, _prosemirrorTestBuilder.br)(), (0, _prosemirrorTestBuilder.code)("foo")), (0, _prosemirrorTestBuilder.p)())
        });
    ...
    it.skip("doesn't return zero-height rectangles after leaves", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)(img))
        });
    ...
    it.skip("produces horizontal rectangles for positions between blocks", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("ha"), (0, _prosemirrorTestBuilder.hr)(), (0, _prosemirrorTestBuilder.blockquote)((0, _prosemirrorTestBuilder.p)("ba")))
        });
    ...
    it.skip("produces sensible screen coordinates around line breaks", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one two three four five-six-seven-eight"))
        });
    ...
    it.skip("can find coordinates on node boundaries", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one ", (0, _prosemirrorTestBuilder.em)("two"), " ", (0, _prosemirrorTestBuilder.em)((0, _prosemirrorTestBuilder.strong)("three"))))
        });
        let prev;
        allPositions(view.state.doc).forEach((pos)=>{
            const coords = view.coordsAtPos(pos, 1);
    ...
    it.skip("finds proper coordinates in RTL text", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("مرآة نثرية"))
        });
    ...
    it.skip("can go back and forth between screen coordsa and document positions", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one"), (0, _prosemirrorTestBuilder.blockquote)((0, _prosemirrorTestBuilder.p)("two"), (0, _prosemirrorTestBuilder.p)("three")))
        });
        [
            1,
            2,
    ...
    it("makes arrow motion go through selectable inline nodes", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("foo<a>", img, "bar"))
        });
        (0, _react.act)(()=>{
    ...
    it("makes arrow motion go through selectable block nodes", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("hello<a>"), (0, _prosemirrorTestBuilder.hr)(), (0, _prosemirrorTestBuilder.ul)((0, _prosemirrorTestBuilder.li)((0, _prosemirrorTestBuilder.p)("there"))))
        });
        (0, _react.act)(()=>{
    ...
    it("supports arrow motion through adjacent blocks", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.blockquote)((0, _prosemirrorTestBuilder.p)("hello<a>")), (0, _prosemirrorTestBuilder.hr)(), (0, _prosemirrorTestBuilder.hr)(), (0, _prosemirrorTestBuilder.p)("there"))
        });
        (0, _react.act)(()=>{
            view.dispatchEvent(event(DOWN));
        });
    ...
    it("support horizontal motion through blocks", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("foo<a>"), (0, _prosemirrorTestBuilder.hr)(), (0, _prosemirrorTestBuilder.hr)(), (0, _prosemirrorTestBuilder.p)("bar"))
        });
        (0, _react.act)(()=>{
            view.dispatchEvent(event(RIGHT));
        });
    ...
    it("allows moving directly from an inline node to a block node", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("foo", img), (0, _prosemirrorTestBuilder.hr)(), (0, _prosemirrorTestBuilder.p)(img, "bar"))
        });
        setSel(view, _prosemirrorState.NodeSelection.create(view.state.doc, 4));
        (0, _react.act)(()=>{
            view.dispatchEvent(event(DOWN));
        });
        expect(view.state.selection.from).toBe(6);
        setSel(view, _prosemirrorState.NodeSelection.create(view.state.doc, 8));
        (0, _react.act)(()=>{
            view.dispatchEvent(event(UP));
        });
        expect(view.state.selection.from).toBe(6);
    ...
    it("updates the selection even if the DOM parameters look unchanged", ()=>{
        const { view , rerender  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("foobar<a>"))
        });
        view.focus();
        const decos = _prosemirrorView.DecorationSet.create(view.state.doc, [
            _prosemirrorView.Decoration.inline(1, 4, {
                color: "green"
            })
        ]);
        rerender({
