...
const Widget = /*#__PURE__*/ (0, _react1.forwardRef)(function Widget(param, ref) {
    let { widget , pos , ...props } = param;
    return /*#__PURE__*/ _react1.default.createElement("var", _extends({
        ref: ref
    }, props), "\xd7");
});
function widgets(positions, sides) {
    return new _prosemirrorState.Plugin({
        state: {
            init (config) {
                const deco = positions.map((p, i)=>(0, _reactWidgetTypeJs.widget)(p, Widget, {
                        side: sides[i]
                    }));
                return config.doc ? _prosemirrorView.DecorationSet.create(config.doc, deco) : _prosemirrorView.DecorationSet.empty;
            },
            apply (tr, deco) {
...
describe("EditorView composition", ()=>{
    it("supports composition in an empty block", ()=>{
        ...
        expect(view.state.doc).toEqualNode((0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("\xe9")));
    });
    it("supports composition at end of block", ()=>{
        ...
        insertComposition(view.dom);
        expect(view.state.doc).toEqualNode((0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("foo\xe9")));
    });
    it("supports composition at start of block in a new node", ()=>{
        ...
        insertComposition(view.dom);
        expect(view.state.doc).toEqualNode((0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("\xe9foo")));
    });
    it("supports composition inside existing text", ()=>{
        ...
        insertComposition(view.dom);
        expect(view.state.doc).toEqualNode((0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("f\xe9oo")));
    });
    ...
    it("handles replacement of existing words", ()=>{
        ...
        insertComposition(view.dom);
        expect(view.state.doc).toEqualNode((0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one \xe9 three")));
    });
    it("handles composition inside marks", ()=>{
        ...
        insertComposition(view.dom);
        expect(view.state.doc).toEqualNode((0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one ", (0, _prosemirrorTestBuilder.em)("two\xe9"))));
    });
    it("handles composition in a mark that has multiple children", ()=>{
        ...
        insertComposition(view.dom);
        expect(view.state.doc).toEqualNode((0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one ", (0, _prosemirrorTestBuilder.em)("two\xe9", (0, _prosemirrorTestBuilder.strong)(" three")))));
    });
    it("supports composition in a cursor wrapper", ()=>{
        ...
        insertComposition(view.dom);
        expect(view.state.doc).toEqualNode((0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)((0, _prosemirrorTestBuilder.em)("\xe9"))));
    });
    it("handles composition in a multi-child mark with a cursor wrapper", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one ", (0, _prosemirrorTestBuilder.em)("two<a>", (0, _prosemirrorTestBuilder.strong)(" three"))))
        });
        view.dispatch(view.state.tr.addStoredMark(_prosemirrorTestBuilder.schema.marks.code.create()));
        insertComposition(view.dom);
        expect(view.state.doc).toEqualNode((0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one ", (0, _prosemirrorTestBuilder.em)("two", (0, _prosemirrorTestBuilder.code)("\xe9"), (0, _prosemirrorTestBuilder.strong)(" three")))));
    });
    ...
    it("works inside highlighted text", ()=>{
        const { view  } = (0, _editorViewTestHelpersJs.tempEditor)({
            doc: (0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one<a> two")),
            plugins: [
                wordHighlighter
            ]
        });
        insertComposition(view.dom);
        expect(view.state.doc).toEqualNode((0, _prosemirrorTestBuilder.doc)((0, _prosemirrorTestBuilder.p)("one\xe9 two")));
    });
