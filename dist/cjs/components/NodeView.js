...
const _customNodeViewJs = require("./CustomNodeView.js");
...
const NodeView = /*#__PURE__*/ (0, _react.memo)(function NodeView(param) {
    ...
    if (Component) {
        ...
        element = /*#__PURE__*/ _react.default.createElement(_customNodeViewJs.CustomNodeView, {
    ...
    const markedElement = node.isInline ? decoratedElement : node.marks.reduce((element, mark)=>/*#__PURE__*/ _react.default.createElement(_markViewJs.MarkView, {
            getPos: getPos,
            mark: mark
